...
const type: ElementsType = "Rating";

const extraAttributes = {
  label: "Rate",
  helperText: "Loved it",
  required: false,
  placeHolder: "Didn't like it",
  options: ["1", "2", "3", "4", "5"],
};
    ...
    <div className="flex flex-col gap-2 w-full">
      ...
      <RadioGroup className="w-full">
        <div className="flex items-center gap-3">
          ...
          <span className="text-muted-foreground text-md">Options</span>
        </div>
      </RadioGroup>
      {/* <Select>
    ...
    <div className="flex flex-col gap-4 w-full ">
      ...
      >
        <div className="flex flex-row gap-5">
          ...
          {/* Use flex and flex-row to display items in a single row */}
            ...
            <div className="flex items-center mr-4" key={index}>
              <div className="text-center ">
                <RadioGroupItem
                  value={option}
                  className={`${
                    index >= 3 ? "hover:bg-green-400" : "hover:bg-red-600"
                  }`}
                />
                <p className="mt-4">{option}</p>
              </div>
            </div>
          ))}
